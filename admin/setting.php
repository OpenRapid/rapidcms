...
<body
    ...
    <div class="mdui-toolbar mdui-color-theme mdui-text-color-white mdui-appbar mdui-appbar-fixed mdui-headroom">
        <button class="drawer mdui-btn mdui-btn-icon mdui-ripple" mdui-drawer="{target: '#drawer', swipe: true}"><i
                    ...
                    <div class="mdui-card-content" style="font-size:15px;text-align:left">
                        <div class="mdui-textfield mdui-textfield-floating-label mdui-textfield-has-bottom ">
                            ...
                            <input class="mdui-textfield-input" name="title" type="text"
                                value="<? echo $data_header["title"];?>" required="">
                        </div>
                        <div class="mdui-textfield mdui-textfield-floating-label mdui-textfield-has-bottom ">
                            <label class="mdui-textfield-label">标签页标题</label>
                            <input class="mdui-textfield-input" name="headname" type="text"
                                value="<? echo $data_header["headname"];?>" required="">
                        </div>
                        <div class="mdui-textfield mdui-textfield-floating-label mdui-textfield-has-bottom ">
                            <label class="mdui-textfield-label">首页简介</label>
                            <input class="mdui-textfield-input" name="introduce" type="text"
                                value="<? echo $data_header["introduce"];?>" required="">
                        </div>
                        <div class="mdui-textfield mdui-textfield-floating-label mdui-textfield-has-bottom ">
                            <label class="mdui-textfield-label">SEO描述</label>
                            <input class="mdui-textfield-input" name="description" type="text"
                                value="<? echo $data_header["description"];?>" required="">
                        </div>
                        <div class="mdui-textfield mdui-textfield-floating-label mdui-textfield-has-bottom ">
                            <label class="mdui-textfield-label">SEO关键词</label>
                            <input class="mdui-textfield-input" name="keywords" type="text"
                                value="<? echo $data_header["keywords"];?>" required="">
                        </div>
                        <label class="mdui-textfield-label">修改图标请直接替换文件 resource/img/icon.png</label>
